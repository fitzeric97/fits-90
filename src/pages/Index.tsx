  ...
  return (
    <div className="min-h-screen bg-primary flex flex-col items-center justify-center p-4">
      ...
      <div className="max-w-sm w-full space-y-4">
        ...
        {/* Apple Login Button */}
        <Button 
          onClick={() => {/* Apple Sign-In logic will go here */}}
          className="w-full h-14 text-lg font-medium bg-black text-white hover:bg-black/90 flex items-center justify-center gap-3"
        >
